...
public class Control4 implements ActionListener {
	...
	public Control4(Game game, String name1, String name2, ArrayList<Champion> team) {
		this.game = game;
		this.name1 = name1;
		this.name2 = name2;
		this.team = team;
		view3 = new View3(name2);
	...
	public void actionPerformed(ActionEvent e) {
		...
		new Control5(game.getFirstPlayer(), game.getSecondPlayer(), name1, name2);
	}
}
